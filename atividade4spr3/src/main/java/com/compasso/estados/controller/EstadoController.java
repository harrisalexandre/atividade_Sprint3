...
public class EstadoController {
	...
	//listar	
	@GetMapping
	@ApiOperation(value="Este metodo retorna lista de estados")
	...
	//detalhar
	@GetMapping("/{id}")
	@ApiOperation(value="Este metodo retorna detalhes de estados")
	...
	@PutMapping("/{id}")
	@Transactional
	@ApiOperation(value="Este metodo atualiza estados")
	...
	@DeleteMapping("/{id}") 
	@Transactional
	@ApiOperation(value="Este metodo apaga estados")
	...
	//cadastrar
	@PostMapping
	@ApiOperation(value="Este metodo cadastra cidade com populacao, area...")
